...
Rigth now we have the development version. You can install lacrmr from github:
...
At first you will need to obtain your user code and API token from your Less Annoying
CRM. Once you have your credentials, you will be able to use the functions
and take your lacrm data into R!
...
with a minimal reproducible example on [github](https://github.com/ixpantia/lacrmr/issues) or send ud an email to
hola@ixpantia.com
