...
searching for.
- **search_contacts** = If you want to make sure a contact exists on your
CRM, this function will return an statement confirming the contact.

## Credentials:

At first you will need to obtain your user code and API from your Less Annoying
CRM. Oonce you have your credentials, you will be able to use the functions
